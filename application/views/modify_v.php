		...
		<div class="col-sm-9 col-sm-offset-1 col-md-10 col-md-offset-1 main">
			...
			<div class="blog-main">
				...
				<div class="blog-post">
					...
					echo form_open_multipart('/index.php/board/edit/board', $attributes);
					?>
					<legend class="sr-only">제목</legend>

					<div class="form-group">
						<label for="input01"></label>
						<input type="text" class="form-control" id="input01" name="title" value="<?php echo $views->title;?>" onblur="javascript:empty_check(document.title);" placeholder="제목을 입력하세요"/>
						<p class="help-block sr-only" >게시글의 제목을 써주세요.</p>
					</div>
					<div class="form-group">
						<label for="input02"></label>
						<textarea id="input02" class="form-control" name="contents" rows="5" onblur="javascript:empty_check(document.contents);" placeholder="내용을 입력하세요"><?php echo $views->contents;?></textarea>
					...
					<div style="margin-top:5px;float:right;">
						<button class="btn btn-default text-right" id="write_btn" >수정</button>
